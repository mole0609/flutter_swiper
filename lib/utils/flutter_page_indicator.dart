...
class MyIndPainter extends BasePainter {
  MyIndPainter(PageIndicator widget, double page, int index, Paint paint)
      : super(widget, page, index, paint);
    ...
    switch (widget.layout) {
      ...
      case PageIndicatorLayout.DROP:
        return new DropPainter(
            widget, widget.controller.page ?? 0.0, index, _paint);
      case PageIndicatorLayout.MYIND:
        return new MyIndPainter(
            widget, widget.controller.page ?? 0.0, index, _paint);
      default:
